...
function llama_place_report_field_icon(
    ...
    $icons = [
        ...
        'flash_flood_risk' => 'at-heavy-rain',
        'wildfire_risk' => 'flame',
        'fall_hazard' => 'fall',
        'cliff_exposure' => 'mountain',
        'rockfall_risk' => 'at-warning',
        'wildlife_risk' => 'deer',
        'traffic_hazard' => 'at-street-cone',
        'emergency_access' => 'medical-cross',
        'road_exposure' => 'road',
        'warning_possible_downed_trees' => 'trees',
        ...
        'warning_leveling_required_derived' => 'scale',
