...
function llama_contribution_level_definitions(): array
{
    return [
        LLAMA_CONTRIBUTION_LEVEL_COMMUNITY => [
            ...
            'icon' => 'users',
            'description' => 'Documented by a signed-in Llama Scout community member.',
        ],
        LLAMA_CONTRIBUTION_LEVEL_MEMBER => [
            ...
            'short_label' => 'Member',
            'icon' => 'user',
            'description' => 'Documented by a paid Llama Scout member with Complete Access.',
        ],
        LLAMA_CONTRIBUTION_LEVEL_SCOUT => [
            ...
            'short_label' => 'Scout',
            'icon' => 'binoculars',
            'description' => 'Documented in the field by a trained Llama Scout.',
        ],
        LLAMA_CONTRIBUTION_LEVEL_MASTER => [
            ...
            'icon' => 'compass',
            'description' => 'Documented in the field by a trained Master Scout.',
        ],
        LLAMA_CONTRIBUTION_LEVEL_ADMIN => [
            ...
            'short_label' => 'Admin',
            'icon' => 'shield-check',
            'description' => 'Documented directly by Llama Scout administration.',
        ],
    ];
}
