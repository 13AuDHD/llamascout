...
function community_place_update_field_definitions(): array
{
    return [
        ...
        'rules.nearest_town' => [
            'label' => 'Distance to nearest town',
            'group' => 'Rules and seasons',
            'type' => 'text',
            'table' => 'place_rules',
            'column' => 'nearest_town',
        ...
        'rules.nearest_fuel' => [
            'label' => 'Distance to nearest fuel',
            'group' => 'Rules and seasons',
            'type' => 'text',
            'table' => 'place_rules',
            'column' => 'nearest_fuel',
        ],
        'rules.nearest_ev_charging' => [
            'label' => 'Distance to nearest EV charging',
            'group' => 'Rules and seasons',
            'type' => 'text',
            'table' => 'place_rules',
            'column' => 'nearest_ev_charging',
        ],
        'rules.nearest_alcohol_sales' => [
            'label' => 'Distance to nearest alcohol sales',
            'group' => 'Rules and seasons',
            'type' => 'text',
            'table' => 'place_rules',
            'column' => 'nearest_alcohol_sales',
        ],
        'rules.nearest_propane' => [
            'label' => 'Distance to nearest propane',
            'group' => 'Rules and seasons',
            'type' => 'text',
            'table' => 'place_rules',
            'column' => 'nearest_propane',
        ],
        'rules.nearest_grocery' => [
            'label' => 'Distance to nearest grocery',
            'group' => 'Rules and seasons',
            'type' => 'text',
            'table' => 'place_rules',
            'column' => 'nearest_grocery',
        ],
        'rules.nearest_water' => [
            'label' => 'Distance to nearest potable water',
            'group' => 'Rules and seasons',
            'type' => 'text',
            'table' => 'place_rules',
            'column' => 'nearest_water',
        ],
        'rules.nearest_toilet' => [
            'label' => 'Distance to nearest public toilet',
            'group' => 'Rules and seasons',
            'type' => 'text',
            'table' => 'place_rules',
            'column' => 'nearest_toilet',
        ],
        'rules.nearest_hospital' => [
            'label' => 'Distance to nearest hospital / emergency care',
            'group' => 'Rules and seasons',
            'type' => 'text',
            'table' => 'place_rules',
