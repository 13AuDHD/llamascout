...
/* =========================================================
   CONTINUE PENDING MEMBERSHIP PURCHASE
   ========================================================= */

/*
 * Billing is for managing an existing membership.
 *
 * If a Free user reaches this page while a membership purchase
 * is already in progress, send them back to the one canonical
 * membership purchase page instead of making them choose again.
 */
...
if (
    ...
    if ($pendingPlan !== '') {
        $membershipQuery['plan'] =
            $pendingPlan;
    }

    if ($pendingPromotionCode !== '') {
        $membershipQuery['promo'] =
            $pendingPromotionCode;
    }
...
/*
 * Only paid subscribers need plan-switching controls here.
 *
 * Starting a new paid membership belongs exclusively to
...
function billing_timestamp_date(
    ?int $value
): string {
...
$notices = [
    ...
    'plan-updated' =>
        'Membership plan updated. Stripe is syncing the change to your account.',

    'cancellation-updated' =>
        'Cancellation preference updated. Your access will follow the billing period shown below.',

    'reactivated' =>
        'Automatic renewal has been restored for this membership.',
];
...
<header class="billing-page-header">
    ...
    <h1>
        Your membership, without leaving Llama Scout.
    </h1>

    <p>
        Review your plan, renewal, payment method and billing history here.
        Stripe still securely handles payment credentials and sensitive
        billing actions.
    </p>
...
<section class="billing-status-card">
    ...
    <span
        class="billing-status-pill <?= $membershipStatus === 'active' && !$cancelAtPeriodEnd
            ? 'is-active'
            : ''
        ?>"
    >
...
<article class="billing-detail-card">
    ...
    <form
        method="post"
        action="/billing-action.php"
        class="billing-inline-action"
    >
...
<section class="billing-management-section">
    ...
    <div class="billing-management-card">
        ...
        <div>
            ...
            <strong>
                Choose your membership from the membership page.
            </strong>

            <p>
                Monthly and annual pricing, current promotions,
                and promotion codes are all handled in one place.
            </p>
...
<section class="billing-management-section">
    ...
    <div class="billing-management-card">
        ...
        <div>
            ...
            <p>
                There is no recurring membership charge associated
                with this access.
            </p>
...
<section class="billing-plans-section">
    ...
    <header>
        ...
        <p class="billing-section-copy">
            Monthly and annual memberships unlock the same member
            features.
        </p>
    ...
    <?php foreach (
        ...
        >
            ...
            <?php elseif (!$cancelAtPeriodEnd): ?>

                <form
                    method="post"
                    action="/billing-action.php"
                    class="billing-plan-form"
                >
    ...
    <div class="billing-management-card">
        ...
        <?php if ($cancelAtPeriodEnd): ?>
            ...
            <div>
                ...
                <p>
                    You keep member access through
                    <?= billing_e(
                        billing_date(
                            $periodEnd
                        )
        ...
        <?php else: ?>
            ...
            <div>
                ...
                <p>
                    Canceling does not remove access immediately.
                    Stripe will show the exact end date before you
                    confirm.
                </p>
...
<section class="billing-history-section">
    ...
    <div class="billing-empty-state">
        ...
        <div>
            ...
            <strong>
                No Stripe invoices to show yet.
            </strong>

            <p>
                Your paid membership invoices will appear here after
                Stripe creates them.
            </p>
...
<section class="billing-advanced-section">
    ...
    <div>
        ...
        <strong>
            Need something not shown here?
        </strong>

        <p>
            Tax IDs and other advanced Stripe-managed billing options
            are available in the secure Stripe portal.
        </p>
...
<section class="billing-explainer">
    ...
    <div>
        ...
        <p>
            Llama Scout stores Stripe customer and subscription
            references so your account knows what access you have.
            Full card numbers and payment credentials are handled by
            Stripe, not stored by Llama Scout.
        </p>
